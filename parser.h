...
void parser(vector<AQLToken> tokens, const string &text, string file_name);
...
void printItem(const vector<int> &widths, const int &size, const AQLView &view);
